...
### Analog Switching • SRAM Cell Design • Low-Power CMOS Classification • Transistor Characterization • Analog Circuit Design • Reference Circuit Design • CMOS Layout Verification
...
This repository contains a collection of **seven Analog IC and VLSI design projects**. The projects cover analog switching with CMOS transmission gates, 6T SRAM memory-cell design, low-power transistor-level classification, MOSFET characterization, analog signal processing, bandgap reference design, and custom CMOS layout verification.
...
[![02 SRAM](https://img.shields.io/badge/02-6T%20SRAM%20CELL-1565C0?style=for-the-badge)](#project-02-sram)
[![03 Classifier](https://img.shields.io/badge/03-LOW--POWER%20CMOS%20CLASSIFIER-7B2CBF?style=for-the-badge)](#project-03-classifier)
[![04 MOSFET](https://img.shields.io/badge/04-MOSFET%20CHARACTERIZATION-2E8B57?style=for-the-badge)](#project-04-mosfet)
[![05 Phase](https://img.shields.io/badge/05-PHASE%20SHIFTER-E63946?style=for-the-badge)](#project-05-phase)
[![06 Bandgap](https://img.shields.io/badge/06-BANDGAP%20REFERENCE-F4A261?style=for-the-badge)](#project-06-bandgap)
[![07 Layout](https://img.shields.io/badge/07-CMOS%20INVERTER%20LAYOUT-5A189A?style=for-the-badge)](#project-07-inverter)
...
| 02 | [**6T SRAM Cell**](#project-02-sram) | CMOS memory / custom layout | Cadence Virtuoso 6.1.5, gpdk090, Spectre/ADE, Assura | Write/hold and read tests; DRC clean; LVS matched; RC extracted view generated |
| 03 | [**Low-Power CMOS Multi-Sensor Threshold Classifier**](#project-03-classifier) | Mixed-signal / VLSI decision circuit | Cadence Virtuoso, gpdk090, Assura DRC/LVS/RCX | Weighted CMOS classifier completed with DRC, LVS, RCX and 105.4 µW average transient power |
| 04 | [**MOSFET Characterization Suite**](#project-04-mosfet) | Device characterization | LTspice 26, TSMC 180nm BSIM3 | NMOS/PMOS Id, gm, gm/Id and small-signal behavior analyzed |
| 05 | [**Voltage-Controlled Phase Shifter**](#project-05-phase) | Analog signal processing | Cadence Virtuoso, gpdk090 nmos1v | Positive phase shift from about 1.18° to 90.66° at 10 kHz |
| 06 | [**Bandgap Reference Circuit**](#project-06-bandgap) | Analog reference design | Cadence Virtuoso, gpdk090 | 1.45 V reference with about 14.2 ppm/°C temperature coefficient |
| 07 | [**CMOS Inverter Layout**](#project-07-inverter) | Physical layout verification | Cadence Virtuoso Layout Suite, gpdk090, Assura | Custom layout passed DRC and LVS verification |
...
---
<a id="project-02-sram"></a>

# 02. 6T SRAM Cell

![Tool](https://img.shields.io/badge/Tool-Cadence%20Virtuoso-blue)
![PDK](https://img.shields.io/badge/PDK-gpdk090-green)
![Memory](https://img.shields.io/badge/Memory-6T%20SRAM-1565C0)
![DRC](https://img.shields.io/badge/DRC-Passed-brightgreen)
![LVS](https://img.shields.io/badge/LVS-Matched-brightgreen)
![Extraction](https://img.shields.io/badge/RC-Extracted%20View%20Generated-brightgreen)

## Summary

This project designs a **single-bit 6T SRAM cell** in Cadence Virtuoso 6.1.5 using gpdk090. Two cross-coupled CMOS inverters store complementary data at `Q` and `Qb`, while two access NMOS transistors connect the storage nodes to `BL` and `BLbar` under word-line (`WL`) control.

The workflow covers schematic design, DC characterization, transient write/hold and read tests, custom layout, DRC error correction, LVS matching, and RC parasitic extraction.

## Design and Functional Verification

| Item | Configuration / Result |
| --- | --- |
| Cell structure | 2 pull-up PMOS, 2 pull-down NMOS, 2 access NMOS |
| Device models and initial sizing | `pmos1v` / `nmos1v`; all six W = 120 nm, L = 100 nm, multiplier = 1 |
| External terminals | VDD, VSS, WL, BL, BLbar |
| DC characterization | Forced-Qb transfer sweep and butterfly-style curves; no numerical SNM measurement |
| Write and hold | Wrote both 1 and 0; retained each state with WL LOW, including bit-line changes |
| Read testbench | 10 fF per bit line; initial conditions represented precharged bit lines and stored data |
| Read 1 | BLbar discharged while BL stayed HIGH; Q retained HIGH after a transient disturbance |
| Read 0 | BL discharged; Q returned LOW after a transient disturbance |

The recorded simulations used **VDD = 1.8 V**; the supported operating voltage of the installed device models was not independently established. Read verification used initialized storage and floating bit-line capacitors, without a physical precharge circuit or sense amplifier.

## Layout and DRC Corrections

Created the layout from the six-transistor core schematic, added gate contacts and body taps, and routed with **Metal1, Metal2, Metal3, and interlayer vias**. PMOS bodies connect to VDD; NMOS bodies connect to VSS. External pins were placed on the appropriate routing layers.

Corrected Nwell width, implant area, Poly area, metal spacing, and metal minimum-area violations. Fixes included correcting pins initially assigned to Poly, extending gate Poly outside active diffusion, rerouting close wires, and enlarging via landing enclosures. DRC was rerun after corrections.
...
| Net / device / pin / parameter mismatches | 0 |
| RC parasitic extraction | Extracted view generated as `av_extracted` |
| Post-layout simulation | Not performed |

## Main Learning Outcome

This project demonstrates SRAM write, hold, and read behavior, along with cross-coupled routing, body connections, interlayer vias, DRC troubleshooting, and schematic-to-layout verification. The project documentation includes step-by-step screenshots, the final layout, an illustrated README, and PDF/DOCX reports.

[⬆ Back to Project Dashboard](#project-dashboard)

---
<a id="project-03-classifier"></a>

# 03. Low-Power CMOS Multi-Sensor Threshold Classifier
...
---
<a id="project-04-mosfet"></a>

# 04. MOSFET Characterization Suite
...
---
<a id="project-05-phase"></a>

# 05. Voltage-Controlled Phase Shifter
...
---
<a id="project-06-bandgap"></a>

# 06. Bandgap Reference Circuit
...
---
<a id="project-07-inverter"></a>

# 07. CMOS Inverter Layout
...
| SRAM design | 6T cell write/hold/read verification, custom layout, DRC closure, LVS matching and RC extraction |
...
| Physical layout | 6T SRAM, CMOS inverter and threshold-classifier custom layout in Cadence Virtuoso |
...
| 6T SRAM Cell | Cadence Virtuoso 6.1.5 with gpdk090, Spectre/ADE, ViVA, Assura DRC/LVS and RC extraction |
...
These seven projects together form a compact Analog IC and VLSI design portfolio. They demonstrate practical understanding of CMOS analog switching, SRAM memory-cell operation, low-power transistor-level classification, MOSFET behavior, analog signal processing, reference circuit design, and CMOS physical layout verification.
